 ...
 */
/**
 * Alias class for Joomla 6 compatibility
 * Factory expects JToolbarButtonCsvExport
 */
...
// Alias for backward compatibility with old code that might reference ToolbarButtonCsvExport
if (!class_exists('ToolbarButtonCsvExport'))
{
