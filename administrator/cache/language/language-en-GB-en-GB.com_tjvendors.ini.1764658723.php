...
return array (
  ...
  'COM_TJVENDORS_N_ITEMS_ARCHIVED' => '%d items successfully archived',
  'COM_TJVENDORS_N_ITEMS_ARCHIVED_1' => '%d item successfully archived',
  'COM_TJVENDORS_N_ITEMS_CHECKED_IN_0' => 'No item successfully checked in',
  'COM_TJVENDORS_N_ITEMS_CHECKED_IN_1' => '%d item successfully checked in',
  'COM_TJVENDORS_N_ITEMS_CHECKED_IN_MORE' => '%d items successfully checked in',
  'COM_TJVENDORS_N_ITEMS_DELETED' => '%d items successfully deleted',
  'COM_TJVENDORS_N_ITEMS_DELETED_1' => '%d item successfully deleted',
  'COM_TJVENDORS_N_ITEMS_PUBLISHED' => '%d items successfully published',
  'COM_TJVENDORS_N_ITEMS_PUBLISHED_1' => '%d item successfully published',
  'COM_TJVENDORS_N_ITEMS_TRASHED' => '%d items successfully trashed',
  'COM_TJVENDORS_N_ITEMS_TRASHED_1' => '%d item successfully trashed',
  'COM_TJVENDORS_N_ITEMS_UNPUBLISHED' => '%d items successfully unpublished',
  'COM_TJVENDORS_N_ITEMS_UNPUBLISHED_1' => '%d item successfully unpublished',
  'COM_TJVENDORS_NO_ITEM_SELECTED' => 'No items selected',
  'COM_TJVENDORS_SAVE_SUCCESS' => 'Item successfully saved',
  ...
  'COM_TJVENDORS_TITLE_VENDORS_FEES' => 'Vendor Fees',
  ...
  'COM_TJVENDORS_VENDOR_UPDATE' => 'Update profile',
  'COM_TJVENDOR_VENDOR_PROFILE' => 'Vendor Profile',
  'COM_TJVENDOR_CREATE_VENDOR' => 'Create Vendor',
  'COM_TJVENDOR_UPDATE_VENDOR' => ' Update Vendor',
  'COM_TJVENDOR_VENDOR_PAYOUT_REPORTS' => 'Payout Reports',
  'COM_TJVENDOR_REGISTRATION_VENDOR_ERROR' => 'Register as a vendor.',
  'COM_TJVENDOR_REPORTS_ERROR' => 'Register as a vendor first.',
  'COM_TJVENDOR_DESCRIPTION_READ_MORE' => '...Read more',
  ...
  'COM_TJVENDOR_EDIT_USER_SPECIFIC_COMMISSION' => ' Edit Commission',
  ...
  'COM_TJVENDORS_FORM_DESC_VENDOR_CURRENCY' => '',
  'COM_TJVENDORS_FORM_LBL_VENDOR_CLIENT' => 'Client',
  'COM_TJVENDORS_FORM_DESC_VENDOR_CLIENT' => '',
  'COM_TJVENDORS_FORM_LBL_VENDOR_TITLE' => 'Vendor Name',
  'COM_TJVENDORS_FORM_DESC_VENDOR_TITLE' => 'Vendor Name',
  ...
  'COM_TJVENDORS_DUPLICATE_CLIENT_ERROR' => 'Already registered for this client. ',
  'COM_TJVENDORS_CLIENT_APPROVAL' => 'Yes',
  'COM_TJVENDORS_CLIENT_REJECTION' => 'No',
  'COM_TJVENDORS_DISPLAY_DO_YOU_WANT_TO_ADD' => 'Do you want to add ',
  'COM_TJVENDORS_DISPLAY_AS_A_CLIENT' => ' as a client',
  'COM_TJVENDORS_DISPLAY_YOU_ARE_ALREADY_A_VENDOR_AS' => 'You are already a vendor.',
  'COM_TJVENDORS_VENDOR_REGISTRATION_DETAILS' => 'Vendor Information',
  'COM_TJVENDORS_VENDOR_PAYMENT_GATEWAY_DETAILS' => 'Payment Gateway Details',
  'COM_TJVENDORS_FORM_LBL_VENDOR_PAYMENT_GATEWAY' => 'Choose Payment Gateway',
  'COM_TJVENDOR_REGISTRATION_REDIRECT_MESSAGE' => 'You are already a vendor for this client.',
  'COM_TJVENDOR_DESCRIPTION_READ_LESS' => '"....Read Less".',
  ...
  'COM_TJVENDORS_VENDORS_MANAGE_PAYOUTS' => 'Manage Payout',
  ...
  'COM_TJVENDORS_PAYOUTS_REFERENCE_ORDER_ID' => 'Reference Order Id',
  'COM_TJVENDORS_PAYOUTS_ID' => 'Id',
  'COM_TJVENDORS_FORM_DESC_PAYOUT_TOTAL_PAYABLE_AMOUNT' => 'Enter the amount you want to pay',
  'COM_TJVENDORS_SEARCH' => 'Search',
  'COM_TJVENDOR_PAYOUTS_SEARCH_BY_CURRENCY' => 'Search by Currency',
  'COM_TJVENDOR_PAYOUTS_EDIT_USER_SPECIFIC_COMM' => ' Edit Payout',
  'COM_TJVENDORS_PAYOUTS_FORM_LBL_VENDOR_ID' => 'Vendor Title',
  ...
  'CONFIRM_MESSAGE_YES_NO' => 'Do you want to procees with the selected payable Amount',
  ...
  'COM_TJVENDORS_REPORTS_AMOUNT' => 'Amount',
  'COM_TJVENDORS_REPORTS_PENDING_AMOUNT' => 'Pending Amount',
  ...
  'JFILTER_PAYOUT_CHOOSE_CLIENTS' => 'All Clients',
  'JSEARCH_CALENDAR_CLEAR' => 'Clear Calendar',
  'COM_TJVENDORS_REPORTS_ENTRY_STATUS' => 'Entry Status',
  'COM_TJVENDORS_REPORTS_CUSTOMER_NOTE' => 'Customer Note',
  ...
  'PLG_ADAPTIVE_PAYPAL_PAYMENET_GATEWAY_EMAIL_ID' => 'Adaptive Email id',
  'PLG_PAYPAL_PRO_PAYMENET_GATEWAY_EMAIL_ID' => 'Paypal Email id',
  ...
  'COM_TJVENDOR_PAYOUT_DONE' => 'Paid',
  'COM_TJVENDOR_PAYOUT_PENDING' => 'Unpaid',
  'COM_TJVENDOR_CREDIT_DONE' => 'Credit done',
  'COM_TJVENDORS_DB_EXCEPTION_WARNING' => 'Error',
  'COM_TJVENDORS_DB_EXCEPTION_WARNING_MESSAGE' => 'Something went wrong',
  'COM_TJVENDORS_SAVE_ALIAS_WARNING' => 'Alias already existed so a number was added at the end. You can re-edit the vendor\'s details to customise the alias.',
  'COM_TJVENDORS_MAXIMUM_LOGO_UPLOAD_SIZE_NOTE' => 'Maximum image size for vendor\'s logo is %s KB',
  ...
  'COM_TJVENDORS_VENDORS_SR_NO' => 'Sr. No.',
  ...
  'COM_TJVENDORS_VENDOR_ADDRESS' => 'Address',
  'COM_TJVENDORS_VENDOR_ZIP' => 'Zip',
  'COM_TJVENDORS_VENDOR_PHONE_NUMBER' => 'Phone Number',
  'COM_TJVENDORS_VENDOR_WEBSITE_ADDRESS' => 'Website URL',
  'COM_TJVENDORS_VENDOR_VAT_NUMBER' => 'VAT Number',
  'COM_TJVENDOR_VENDOR_FORM_AJAX_FAIL_ERROR_MESSAGE' => 'Something went wrong',
  'JGLOBAL_MAXIMUM_UPLOAD_SIZE_LIMIT' => '',
  'COM_TJVENDORS_FROM' => 'From',
  'COM_TJVENDORS_TO' => 'To',
);
